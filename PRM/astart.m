...
a = imread('ss.bmp');
b = medfilt2(a, [11,11]);
map=im2bw(b); % input map read from a bmp file. for new maps write the file name here
source=[263 155]; % source position in Y, X format
goal=[786 1488]; % goal position in Y, X format
k=400; % number of points in the PRM
display=1; % display processing of nodes
